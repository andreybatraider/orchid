  ...
  return (
    <HeroUINavbar maxWidth="xl" position="sticky">
      ...
      >
        ...
        <a href="https://www.youtube.com/@ORCHIDCUP" target="_blank" className="">
        ...
        <a href="https://www.twitch.tv/orchidcup" target="_blank" className=""><svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://vk.com/orchidcybercup" target="_blank" className=""><svg width="21" height="12" viewBox="0 0 21 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://t.me/orchidcup" target="_blank" className=""><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <NavbarItem className="hidden md:flex">
          <Button
            isExternal
            as={Link}
            className="text-sm rounded-none text-white font-bold bg-[#FF2F71]"
      ...
      <NavbarMenu>
        <div className="mx-4 mt-2 flex flex-col gap-2">
          <NavbarMenuItem>
            <Link color="primary" href="/portfolio" size="lg">
              Меню
            </Link>
          </NavbarMenuItem>
          <NavbarMenuItem>
          ...
          <NavbarMenuItem>
            <Link color="foreground" href="/tournament" size="lg">
              Турниры
            </Link>
          </NavbarMenuItem>

          <NavbarMenuItem>
            <Link color="foreground" href="/price" size="lg">
              Услуги
            </Link>
          </NavbarMenuItem>
