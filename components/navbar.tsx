    ...
    <HeroUINavbar maxWidth="xl" position="sticky">
      ...
      >
        <NavbarItem className="hidden sm:flex gap-2">
          ...
          {socialLinks.twitch && (
            <a href={socialLinks.twitch} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
          ...
          {socialLinks.vk && (
            <a href={socialLinks.vk} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
          ...
          {socialLinks.discord && (
            <a href={socialLinks.discord} target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
              <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
